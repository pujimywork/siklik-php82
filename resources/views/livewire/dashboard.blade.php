...
new class extends Component {
    ...
    public function masterMenus(): array
    {
        ...
        $rows = array_filter([
            ...
            $entry(['group' => 'Master', 'groupOrder' => 1, 'order' => 7,  'route' => 'master.laborat',      'title' => 'Master Kategori Lab',  'desc' => 'Kategori pemeriksaan lab (Hematologi, Kimia, dll)', 'roles' => ['admin', 'laboratorium'], 'badge' => 'Master']),
            $entry(['group' => 'Master', 'groupOrder' => 1, 'order' => 8,  'route' => 'master.laborat.clabitem', 'title' => 'Master Item Pemeriksaan Lab', 'desc' => 'Item lab dgn nilai normal M/F + limit + LOINC',   'roles' => ['admin', 'laboratorium'], 'badge' => 'Master']),
