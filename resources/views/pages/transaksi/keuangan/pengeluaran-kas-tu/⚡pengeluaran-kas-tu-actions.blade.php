                    ...
                    <x-border-form title="Data Pengeluaran Kas (Cash-Out)"
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                {{-- Akun Pengeluaran (CO) --}}
                                <div>
                                    <livewire:lov.akun.lov-akun target="akun-co-tu" label="Akun Pengeluaran" :initialAccId="$accId"
                                ...
                                <div x-ref="lovKasCoWrapper">
                                    <livewire:lov.akun.lov-akun target="akun-kas-tu-co" :kasOnly="true" label="Akun Kas" :initialAccId="$accIdKas"
