...
class DiagKeperawatanSeeder extends Seeder
{
    ...
    private function getData(): array
    {
        return [
            ...
            // D.0129 — Gangguan Integritas Kulit/Jaringan (updated from PDF p.637-639)
            ['diagkep_id' => 'D.0129', 'diagkep_desc' => 'Gangguan Integritas Kulit/Jaringan', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Kerusakan kulit (dermis dan/atau epidermis) atau jaringan (membran mukosa, kornea, fasia, otot, tendon, tulang, kartilago, kapsul sendi dan/atau ligamen)', 'penyebab' => ['fisiologis' => ['Perubahan sirkulasi', 'Perubahan status nutrisi (kelebihan atau kekurangan)', 'Kekurangan/kelebihan volume cairan', 'Penurunan mobilitas', 'Bahan kimia iritatif', 'Suhu lingkungan yang ekstrem', 'Faktor mekanis (mis. penekanan pada tonjolan tulang, gesekan) atau faktor elektris (elektrodiatermi, energi listrik bertegangan tinggi)', 'Efek samping terapi radiasi', 'Kelembaban', 'Proses penuaan', 'Neuropati perifer', 'Perubahan pigmentasi', 'Perubahan hormonal', 'Kurang terpapar informasi tentang upaya mempertahankan/melindungi integritas jaringan']], 'gejala_tanda_mayor' => ['subjektif' => ['Tidak tersedia'], 'objektif' => ['Kerusakan jaringan dan/atau lapisan kulit']], 'gejala_tanda_minor' => ['subjektif' => ['Tidak tersedia'], 'objektif' => ['Nyeri', 'Perdarahan', 'Kemerahan', 'Hematoma']], 'kondisi_klinis_terkait' => ['Imobilisasi', 'Gagal jantung kongestif', 'Gagal Ginjal', 'Diabetes Melitus', 'Imunodefisiensi (mis. AIDS)']], 'slki' => [['kode' => 'L.14125', 'nama' => 'Integritas Kulit dan Jaringan', 'kriteria_hasil' => ['Elastisitas cukup meningkat', 'Hidrasi cukup meningkat', 'Perfusi jaringan cukup meningkat', 'Kerusakan jaringan cukup menurun', 'Kerusakan lapisan kulit cukup menurun', 'Nyeri cukup menurun', 'Perdarahan cukup menurun', 'Kemerahan cukup menurun', 'Hematoma cukup menurun', 'Pigmentasi abnormal cukup menurun', 'Jaringan parut cukup menurun', 'Nekrosis cukup menurun', 'Abrasi kornea cukup menurun', 'Suhu kulit cukup membaik', 'Sensasi cukup membaik', 'Tekstur cukup membaik', 'Pertumbuhan rambut cukup membaik']]], 'siki' => [['kode' => 'I.11353', 'nama' => 'Perawatan Integritas Kulit', 'definisi' => 'Mengidentifikasi dan merawat kulit untuk menjaga keutuhan, kelembaban dan mencegah perkembangan mikroorganisme', 'tindakan' => ['observasi' => ['Identifikasi penyebab gangguan integritas kulit (mis. perubahan sirkulasi, perubahan status nutrisi, penurunan kelembaban, suhu lingkungan ekstrem, penurunan mobilitas)'], 'terapeutik' => ['Ubah posisi tiap 2 jam jika tirah baring', 'Lakukan pemijatan pada area penonjolan tulang, jika perlu', 'Bersihkan perineal dengan air hangat, terutama selama periode diare', 'Gunakan produk berbahan petroleum dan minyak pada kulit kering', 'Gunakan produk berbahan ringan/alami dan hipoalergik pada kulit sensitif', 'Hindari produk berbahan dasar alkohol pada kulit kering'], 'edukasi' => ['Anjurkan menggunakan pelembab (mis. lotion, serum)', 'Anjurkan minum air yang cukup', 'Anjurkan meningkatkan asupan nutrisi', 'Anjurkan meningkatkan asupan buah dan sayur', 'Anjurkan menghindari terpapar suhu ekstrem', 'Anjurkan menggunakan tabir surya SPF minimal 30 saat berada di luar rumah', 'Anjurkan mandi dan menggunakan sabun secukupnya'], 'kolaborasi' => []]], ['kode' => 'I.11348', 'nama' => 'Dukungan Perawatan Diri', 'definisi' => 'Memfasilitasi pemenuhan kebutuhan perawatan diri', 'tindakan' => ['observasi' => ['Identifikasi kebiasaan aktivitas perawatan diri sesuai usia', 'Monitor tingkat kemandirian', 'Identifikasi kebutuhan alat bantu kebersihan diri, berpakaian, berhias, dan makan'], 'terapeutik' => ['Sediakan lingkungan yang terapeutik (mis. suasana hangat, rileks, privasi)', 'Siapkan keperluan abadi (mis. parfum, sikat gigi, dan sabun mandi)', 'Damping dalam melakukan perawatan diri sampai mandiri', 'Fasilitasi untuk menerima keadaan ketergantungan', 'Fasilitasi kemandirian, bantu jika tidak mampu melakukan perawatan diri', 'Jadwalkan rutinitas perawatan diri'], 'edukasi' => ['Anjurkan melakukan perawatan diri secara konsisten sesuai kemampuan'], 'kolaborasi' => []]], ['kode' => 'I.12441', 'nama' => 'Edukasi Program Pengobatan', 'definisi' => 'Mengajarkan penggunaan obat secara aman dan efektif', 'tindakan' => ['observasi' => ['Identifikasi pengetahuan tentang pengobatan yang direkomendasikan', 'Identifikasi penggunaan pengobatan tradisional dan kemungkinan efek terhadap pengobatan'], 'terapeutik' => ['Fasilitasi informasi tertulis atau gambar untuk meningkatkan pemahaman', 'Berikan dukungan untuk menjalani program pengobatan dengan baik dan benar', 'Libatkan keluarga untuk memberikan dukungan pada pasien selama pengobatan'], 'edukasi' => ['Jelaskan manfaat dan efek samping pengobatan', 'Jelaskan strategi mengelola efek samping obat', 'Jelaskan cara penyimpanan, pengisian kembali/pembelian kembali, dan pemantauan sisa obat', 'Jelaskan keuntungan dan kerugian program pengobatan, jika perlu', 'Informasikan fasilitas kesehatan yang dapat digunakan selama pengobatan', 'Anjurkan memonitor perkembangan keefektifan pengobatan', 'Anjurkan mengkonsumsi obat sesuai indikasi', 'Anjurkan bertanya jika ada sesuatu yang tidak dimengerti sebelum dan sesudah pengobatan dilakukan', 'Ajarkan kemampuan melakukan pengobatan mandiri (self-medication)'], 'kolaborasi' => []]], ['kode' => 'I.12461', 'nama' => 'Konsultasi', 'definisi' => 'Memberikan pertimbangan untuk memecahkan masalah keperawatan dan/atau kesehatan yang dialami pasien, keluarga, kelompok atau komunitas', 'tindakan' => ['observasi' => ['Identifikasi tujuan konsultasi', 'Identifikasi masalah yang menjadi fokus konsultasi', 'Identifikasi harapan semua pihak yang terlibat', 'Identifikasi model konsultasi yang sesuai', 'Identifikasi ekspektasi biaya, jika perlu'], 'terapeutik' => ['Fasilitasi kontrak tertulis untuk menentukan kesepakatan jadwal konsultasi', 'Berikan tanggapan secara profesional terhadap penerimaan atau penolakan ide', 'Fasilitasi memutuskan pilihan alternatif solusi'], 'edukasi' => ['Jelaskan masalah yang sedang dihadapi pasien', 'Jelaskan alternatif solusi yang dapat dilakukan oleh pasien/keluarga', 'Jelaskan keuntungan dan kerugian masing-masing solusi', 'Anjurkan meningkatkan kemandirian menyelesaikan masalah'], 'kolaborasi' => []]]]]],
            // D.0130 — Hipertermia (updated from PDF p.645-646)
            ['diagkep_id' => 'D.0130', 'diagkep_desc' => 'Hipertermia', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Suhu tubuh meningkat di atas rentang normal tubuh', 'penyebab' => ['fisiologis' => ['Dehidrasi', 'Terpapar lingkungan panas', 'Proses penyakit (mis. infeksi, kanker)', 'Ketidaksesuaian pakaian dengan suhu lingkungan', 'Peningkatan laju metabolisme', 'Respon trauma', 'Aktivitas berlebihan', 'Penggunaan inkubator']], 'gejala_tanda_mayor' => ['subjektif' => ['Tidak tersedia'], 'objektif' => ['Suhu tubuh di atas nilai normal']], 'gejala_tanda_minor' => ['subjektif' => ['Tidak tersedia'], 'objektif' => ['Kulit merah', 'Kejang', 'Takikardi', 'Takipnea', 'Kulit terasa hangat']], 'kondisi_klinis_terkait' => ['Proses Infeksi', 'Hipertiroid', 'Stroke', 'Dehidrasi', 'Trauma', 'Prematuritas']], 'slki' => [['kode' => 'L.14134', 'nama' => 'Termoregulasi', 'kriteria_hasil' => ['Menggigil menurun', 'Kulit merah menurun', 'Kejang menurun', 'Suhu tubuh menurun', 'Suhu kulit membaik']]], 'siki' => [['kode' => 'I.15506', 'nama' => 'Manajemen Hipertermia', 'definisi' => 'Mengidentifikasi dan mengelola peningkatan suhu tubuh', 'tindakan' => ['observasi' => ['Identifikasi penyebab hipertermia (mis. dehidrasi, terpapar lingkungan panas, penggunaan inkubator)', 'Monitor suhu tubuh', 'Monitor kasar elektrolit', 'Monitor haluaran urine', 'Monitor komplikasi akibat hipertermia'], 'terapeutik' => ['Sediakan lingkungan yang dingin', 'Longgarkan atau lepaskan pakaian', 'Basahi dan kipasi permukaan tubuh', 'Berikan cairan oral', 'Ganti linen setiap hari atau lebih sering jika mengalami hyperhidrosis (keringat berlebih)', 'Lakukan pendinginan eksternal (mis. selimut hiportermia atau kompres dingin pada dahi, leher, dada, abdomen, aksila)', 'Hindari pemberian antipiretik atau aspirin', 'Berikan oksigen, jika perlu'], 'edukasi' => ['Anjurkan tirah baring'], 'kolaborasi' => ['Kolaborasi pemberian cairan dan elektrolit intravena jika perlu']]]]]],
            // D.0131 — Hipotermia (updated from PDF p.647-649)
            ['diagkep_id' => 'D.0131', 'diagkep_desc' => 'Hipotermia', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Suhu tubuh berada dibawah rentang normal tubuh', 'penyebab' => ['fisiologis' => ['Kerusakan hipotalamus', 'Konsumsi alkohol', 'Berat badan ekstrem', 'Kekurangan lemak subkutan', 'Terpapar suhu lingkungan rendah', 'Malnutrisi', 'Pemakaian pakaian tipis', 'Penurunan laju metabolisme', 'Tidak beraktivitas', 'Transfer panas (mis. konduksi, konvesi, evaporasi, radiasi)', 'Trauma', 'Proses penuaan', 'Efek agen farmakologis', 'Kurang terpapar informasi tentang pencegahan hipotermia']], 'gejala_tanda_mayor' => ['subjektif' => ['Tidak tersedia'], 'objektif' => ['Kulit teraba dingin', 'Menggigil', 'Suhu tubuh di bawah nilai normal']], 'gejala_tanda_minor' => ['subjektif' => ['Tidak tersedia'], 'objektif' => ['Akrosianosis', 'Bradikardi', 'Dasar kuku sianotik', 'Hipoglikemia', 'Hipoksia', 'Pengisian kapiler >3 detik', 'Konsumsi oksigen meningkat', 'Ventilasi menurun', 'Piloereksi', 'Takikardia', 'Vasokontriksi perifer', 'Kutis memorata (pada neonatus)']], 'kondisi_klinis_terkait' => ['Hipotiroidisme', 'Anoreksia nervosa', 'Cedera batang otak', 'Prematuritas', 'Berat badan lahir rendah (BBLR)', 'Tenggelam']], 'slki' => [['kode' => 'L.14134', 'nama' => 'Termoregulasi', 'kriteria_hasil' => ['Menggigil menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Kulit merah menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Kejang menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Suhu tubuh menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Akrosianosis menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Konsumsi oksigen menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Piloereksi menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Vasokontriksi perifer menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Kutis memorata menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Pucat menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Takipnea menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Bradikardi menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Dasar kuku sianotik menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Hipoksia menurun dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Suhu tubuh dari skala 1 (Memburuk) menjadi skala 4 (Cukup membaik)', 'Suhu kulit dari skala 1 (Memburuk) menjadi skala 4 (Cukup membaik)', 'Kadar Glukosa darah dari skala 1 (Memburuk) menjadi skala 4 (cukup membaik)', 'Pengisian Kapiler dari skala 1 (Memburuk) menjadi skala 4 (Cukup membaik)', 'Ventilasi dari skala 1 (Memburuk) menjadi skala 4 (Cukup membaik)', 'Tekanan darah dari skala 1 (Memburuk) menjadi skala 4 (Cukup membaik)']]], 'siki' => [['kode' => 'I.14507', 'nama' => 'Manajemen Hipotermia', 'definisi' => 'Mengidentifikasi dan mengelola suhu tubuh di bawah rentang normal', 'tindakan' => ['observasi' => ['Monitor suhu tubuh', 'Identifikasi penyebab hipotermia (mis. terpapar suhu lingkungan rendah, pakaian tipis, kerusakan hipotalamus, penurunan laju metabolisme, kekurangan lemak subkutan)', 'Monitor tanda dan gejala akibat hipotermia (hipotermia ringan: takipnea, disatria, menggigil, hipertensi; Hipotermia sedang: aritmia, hipotensi, apatis, koagulopati, reflex menurun; Hipotermia berat: oliguria, refleks menghilang, edema paru, asam-basa abnormal)'], 'terapeutik' => ['Sediakan lingkungan yang hangat (mis. atur suhu ruangan, inkubator)', 'Lakukan penghangatan aktif eksternal (mis. kompres hangat, botol hangat, selimut hangat, perawatan metode kangguru)'], 'edukasi' => ['Anjurkan makan/minum hangat'], 'kolaborasi' => []]]]]],
            // D.0132 — Perilaku Kekerasan (updated from PDF p.650)
            ['diagkep_id' => 'D.0132', 'diagkep_desc' => 'Perilaku Kekerasan', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Kemarahan yang diekspresikan secara berlebihan dan tidak terkendali secara verbal sampai dengan mencederai orang lain dan merusak lingkungan', 'penyebab' => ['fisiologis' => ['Ketidakmampuan mengendalikan dorongan mengendalikan dorongan darah', 'Stimulus lingkungan', 'Konflik interpersonal', 'Perubahan status mental', 'Putus obat', 'Penyalahgunaan zat/alkohol']], 'gejala_tanda_mayor' => ['subjektif' => ['Mengancam', 'Mengumpat dengan kata-kata kasar', 'Suara Keras', 'Bicara Ketus'], 'objektif' => ['Menyerang orang lain', 'Melukai diri sendiri/orang lain', 'Merusak lingkungan', 'Perilaku agresif/amuk']], 'gejala_tanda_minor' => ['subjektif' => ['Tidak tersedia'], 'objektif' => ['Tidak tersedia']], 'kondisi_klinis_terkait' => ['Tidak tersedia']], 'slki' => [['kode' => 'L.09076', 'nama' => 'Kontrol Diri', 'kriteria_hasil' => ['Perilaku melukai diri dari skala 1 meningkat menjadi skala 5 menurun', 'Verbalisasi keinginan bunuh diri dari skala 1 meningkat menjadi skala 5 menurun', 'Perilaku merencanakan bunuh diri dari skala 1 meningkat menjadi skala 5 menurun']]], 'siki' => [['kode' => 'I.12403', 'nama' => 'Manajemen Perilaku', 'definisi' => 'Mengidentifikasi dan mengelola perilaku negatif', 'tindakan' => ['observasi' => ['Identifikasi harapan untuk mengendalikan perilaku'], 'terapeutik' => ['Diskusikan tanggung jawab terhadap perilaku', 'Jadwalkan kegiatan terstruktur', 'Ciptakan dan pertahankan lingkungan dan kegiatan perawatan konsisten setiap dinas', 'Tingkatkan aktivitas fisik sesuai kemampuan', 'Batasi jumlah pengunjung', 'Bicara dengan nada rendah dan tenang', 'Lakukan kegiatan pengalihan terhadap sumber agitasi', 'Cegah perilaku pasif dan agresif', 'Beri penguatan positif terhadap keberhasilan mengendalikan perilaku', 'Lakukan pengekangan fisik sesuai indikasi', 'Hindari bersikap menyudutkan dan menghentikan pembicaraan'], 'edukasi' => ['Jelaskan masalah yang sedang dihadapi pasien', 'Jelaskan alternatif solusi yang dapat dilakukan oleh pasien/keluarga', 'Jelaskan keuntungan dan kerugian masing-masing solusi', 'Anjurkan meningkatkan kemandirian menyelesaikan masalah'], 'kolaborasi' => []]]]]],
            // D.0133 — Perlambatan Pemulihan Pascabedah (updated from PDF p.651-653)
            ['diagkep_id' => 'D.0133', 'diagkep_desc' => 'Perlambatan Pemulihan Pascabedah', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Pemanjangan jumlah hari pascabedah untuk memulai dan melakukan aktivitas sehari-hari', 'penyebab' => ['fisiologis' => ['Skor klasifikasi status fisik American Society of Anesthesiologists (ASA) lebih dari 3', 'Hiperglikemia', 'Edema pada lokasi pembedahan', 'Prosedur pembedahan ekstensif (luas)', 'Usia ekstrem', 'Riwayat perlambatan penyembuhan luka', 'Gangguan mobilitas', 'Malnutrisi', 'Obesitas', 'Infeksi luka perioperative', 'Mual/muntah persisten', 'Respon emosional pascaoperasi', 'Pemanjangan proses operasi', 'Gangguan psikologis pascaoperasi', 'Kontaminasi bedah', 'Trauma pada luka operasi', 'Efek agen farmakologis']], 'gejala_tanda_mayor' => ['subjektif' => ['Mengeluh tidak nyaman'], 'objektif' => ['Area luka operasi terbuka', 'Waktu penyembuhan yang memanjang']], 'gejala_tanda_minor' => ['subjektif' => ['Selera makan hilang'], 'objektif' => ['Gangguan mobilitas', 'Tidak mampu melanjutkan pekerjaan', 'Memulai pekerjaan tertunda', 'Membutuhkan bantuan untuk perawatan diri']], 'kondisi_klinis_terkait' => ['Tindakan operasi besar', 'Trauma yang memerlukan intervensi bedah']], 'slki' => [['kode' => 'L.14129', 'nama' => 'Pemulihan Pasca Bedah', 'kriteria_hasil' => ['Kenyamanan dari skala 1 menurun menjadi skala 5 meningkat', 'Kemampuan melanjutkan pekerjaan dari skala 1 menurun menjadi skala 5 meningkat', 'Kondisi area luka operasi dari skala 1 memburuk menjadi skala 5 membaik']]], 'siki' => [['kode' => 'I.08238', 'nama' => 'Manajemen Nyeri', 'definisi' => 'Mengidentifikasi dan mengelola pengalaman sensorik atau emosional yang berkaitan dengan kerusakan jaringan atau fungsional dengan onset mendadak atau lambat dan berintesitas ringan hingga berat dan konstan', 'tindakan' => ['observasi' => ['Identifikasi lokasi, karakteristik, durasi, frekuensi, kualitas, intensitas nyeri', 'Identifikasi skala nyeri', 'Identifikasi respon nyeri non verbal', 'Identifikasi faktor yang memperberat dan memperingan nyeri', 'Identifikasi pengetahuan dan keyakinan tentang nyeri', 'Identifikasi pengaruh budaya terhadap respon nyeri', 'Identifikasi pengaruh nyeri pada kualitas hidup', 'Monitor keberhasilan terapi komplementer yang sudah diberikan', 'Monitor efek samping penggunaan analgetik terapeutik'], 'terapeutik' => ['Berikan Teknik nonfarmakologis untuk mengurangi rasa nyeri (mis. TENS, hypnosis, akupresur, terapi musik, biofeedback, terapi pijat, aromaterapi, Teknik imajinasi terbimbing, kompres hangat/dingin, terapi bermain)', 'Kontrol lingkungan yang memperberat rasa nyeri (mis. Suhu ruangan, pencahayaan, kebisingan)', 'Fasilitasi istirahat dan tidur', 'Pertimbangkan jenis dan sumber nyeri dalam pemilihan strategi meredakan nyeri'], 'edukasi' => ['Jelaskan penyebab, periode dan pemicu nyeri', 'Jelaskan strategi meredakan nyeri', 'Anjurkan memonitor nyeri secara mandiri', 'Anjurkan menggunakan analgetik secara tepat', 'Ajarkan Teknik nonfarmakologis untuk mengurangi rasa nyeri'], 'kolaborasi' => ['Kolaborasi pemberian analgetik, jika perlu']]]]]],
            // D.0134 — Risiko Alergi (updated from PDF p.654-662)
            ['diagkep_id' => 'D.0134', 'diagkep_desc' => 'Risiko Alergi', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami stimulasi respon yang berlebihan akibat terpapar alergen', 'penyebab' => [], 'faktor_risiko' => ['Makanan (mis. alpukat, pisang, kiwi, kacang, makanan olahan laut, buah tropis, jamur)', 'Terpapar zat alergen (mis. zat kimia, agen farmakologis)', 'Terpapar alergen lingkungan (mis. debu, serbuk sari)', 'Sengatan serangga'], 'kondisi_klinis_terkait' => ['Kondisi penurunan imunitas', 'Riwayat pembedahan', 'Riwayat alergi sebelumnya', 'Asma']], 'slki' => [['kode' => 'L.14131', 'nama' => 'Respon Alergi Lokal', 'kriteria_hasil' => ['Nyeri dari skala 1 meningkat menjadi skala 5 menurun', 'Gatal lokal dari skala 1 meningkat menjadi skala 5 menurun', 'Sekresi Mukus dari skala 1 meningkat menjadi skala 5 menurun', 'Bersin dari skala 1 meningkat menjadi skala 5 menurun', 'Eritema lokal dari skala 1 meningkat menjadi skala 5 menurun', 'Konjungtivitis dari skala 1 meningkat menjadi skala 5 menurun', 'Lakrimasi dari skala 1 meningkat menjadi skala 5 menurun', 'Rhinitis dari skala 1 meningkat menjadi skala 5 menurun', 'Edema Lokal dari skala 1 meningkat menjadi skala 5 menurun'], ['kode' => 'L.14132', 'nama' => 'Respon Alergi Sistemik', 'kriteria_hasil' => ['Gatal seluruh tubuh dari skala 1 meningkat menjadi skala 5 menurun', 'Eritema dari skala 1 meningkat menjadi skala 5 menurun', 'Tekanan darah dari skala 1 memburuk menjadi skala 5 membaik', 'Frekuensi nadi dari skala 1 memburuk menjadi skala 5 membaik']]]], 'siki' => [['kode' => 'I.12445', 'nama' => 'Edukasi Reaksi Alergi', 'definisi' => 'Mengajarkan cara mengidentifikasi, mengelola dan mencegah reaksi alergi', 'tindakan' => ['observasi' => ['Identifikasi kemampuan pasien dan keluarga menerima informasi', 'Monitor pemahaman pasien dan keluarga tentang alergi'], 'terapeutik' => ['Sediakan materi dan media pendidikan kesehatan', 'Jadwalkan pendidikan kesehatan sesuai kesepakatan', 'Fasilitasi mengenali penyebab alergi', 'Berikan kesempatan pasien dan keluarga bertanya'], 'edukasi' => ['Jelaskan definisi, penyebab, gejala dan tanda alergi', 'Jelaskan menghindari alergen (mis. tidak menggunakan karpet, menggunakan masker)', 'Anjurkan pasien dan keluarga menyediakan obat alergi'], 'kolaborasi' => []]], ['kode' => 'I.14535', 'nama' => 'Pencegahan Alergi', 'definisi' => 'Mengidentifikasi dan menurunkan risiko pasien mengalami reaksi alergi', 'tindakan' => ['observasi' => ['Identifikasi riwayat alergi (obat, makanan, debu, udara)', 'Monitor terhadap reaksi obat, makanan, lateks, transfusi darah atau produk darah atau alergen lainnya'], 'terapeutik' => ['Berikan tanda alergi pada rekam medis', 'Pasang gelang tanda alergi pada lengan', 'Hentikan paparan alergen', 'Lakukan tes alergi sebelum pemberian obat'], 'edukasi' => ['Ajarkan menghindari dan mencegah paparan alergen'], 'kolaborasi' => ['Kolaborasi dengan tenaga kesehatan dalam pencegahan alergi (mis. dokter, ahli gizi)']]]]]],
            // D.0135 — Risiko Bunuh Diri (updated from PDF p.663-664)
            ['diagkep_id' => 'D.0135', 'diagkep_desc' => 'Risiko Bunuh Diri', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko melakukan upaya menyakiti diri sendiri untuk mengakhiri kehidupan', 'penyebab' => [], 'faktor_risiko' => ['Gangguan perilaku (mis. Euforia mendadak setelah depresi, perilaku mencari senjata berbahaya, membeli obat dalam jumlah banyak, membuat surat wasiat)', 'Demografi (mis. Lansia, status perceraian, janda/duda, ekonomi rendah, pengangguran)', 'Gangguan fisik (mis. Nyeri kronis, penyakit terminal)', 'Masalah sosial (mis. Berduka, tidak berdaya, putus asa, kesepian, kehilangan hubungan yang penting, isolasi sosial)', 'Gangguan psikologis (mis. Penganiayaan masa kanak-kanak, riwayat bunuh diri sebelumnya, remaja homoseksual, gangguan psikiatrik, penyakit psikiatrik, penyalahgunaan zat)'], 'kondisi_klinis_terkait' => ['Sindrom otak akut/kronis', 'Ketidakseimbangan hormon (mis. Premenstrual syndrom, postpartum psychosis)', 'Penyalahgunaan zat', 'Post traumatic stress disorder (PTSD)', 'Penyakit kronis/terminal (mis. Kanker)']], 'slki' => [['kode' => 'L.09076', 'nama' => 'Kontrol Diri', 'kriteria_hasil' => ['Perilaku melukai diri sendiri/orang lain dari skala 1 meningkat menjadi skala 5 menurun', 'Verbalisasi keinginan bunuh diri dari skala 1 meningkat menjadi skala 5 menurun', 'Verbalisasi isyarat bunuh diri dari skala 1 meningkat menjadi skala 5 menurun', 'Verbalisasi ancaman bunuh diri dari skala 1 meningkat menjadi skala 5 menurun', 'Verbalisasi rencana bunuh diri dari skala 1 meningkat menjadi skala 5 menurun', 'Perilaku merencanakan bunuh diri dari skala 1 meningkat menjadi skala 5 menurun', 'Alam perasaan depresi dari skala 1 meningkat menjadi skala 5 menurun']]], 'siki' => [['kode' => 'I.14538', 'nama' => 'Pencegahan Bunuh Diri', 'definisi' => 'Mengidentifikasi dan menurunkan risiko merugikan diri sendiri dengan maksud mengakhiri hidup', 'tindakan' => ['observasi' => ['Identifikasi gejala risiko bunuh diri (mis. Gangguan mood, halusinasi, delusi, panik, penyalahgunaan zat, kesedihaan, gangguan kepribadian)', 'Identifikasi keinginan dan pikiran rencana bunuh diri', 'Monitor lingkungan bebas bahaya secara rutin (mis. Barang pribadi, pisau cukur, jendela)'], 'terapeutik' => ['Libatkan dalam perencanaan perawatan mandiri', 'Libatkan keluarga dalam perencanaan perawatan', 'Berikan lingkungan dengan pengamanan ketat dan mudah dipantau (mis. tempat tidur dekat ruangan perawat)', 'Tingkatkan pengawasan pada kondisi tertentu (mis. Rapat staf, pergantian shift)', 'Lakukan intervensi perlindungan (mis. Pembatasan area, pengekangan fisik), jika diperlukan', 'Hindari diskusi berulang tentang bunuh diri sebelumnya, diskusi berorientasi pada masa sekarang dari masa depan', 'Diskusikan rencana menghadapi ide bunuh diri dimasa depan (mis. Orang yang dihubungi, kemana mencari bantuan)', 'Pastikan obatan ditelan'], 'edukasi' => ['Anjurkan mendiskusikan perasaan yang dialami kepada orang lain', 'Anjurkan menggunakan sumber pendukung (Mis. Layanan spiritual, penyediaan layanan)', 'Jelaskan tindakan pencegahan bunuh diri kepada keluarga atau orang terdekat', 'Informasikan sumber daya masyarakat dan program yang tersedia', 'Latih pencegahan bunuh diri (mis. Latihan asertif, relaksasi otot progesif)'], 'kolaborasi' => ['Kolaborasi pemberian obat antiansietas, atau atipsikotik, sesuai indikasi', 'Kolaborasi tindakan keselamatan kepada PPA', 'Rujuk kepelayanan kesehatan mental, jika perlu']]]]]],
            // D.0136 — Risiko Cedera (updated from PDF p.665)
            ['diagkep_id' => 'D.0136', 'diagkep_desc' => 'Risiko Cedera', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami bahaya atau kerusakan fisik yang menyebabkan seseorang tidak lagi sepenuhnya sehat atau dalam kondisi baik', 'penyebab' => [], 'faktor_risiko' => ['Eksternal' => ['Terpapar patogen', 'Terpapar zat kimia toksik', 'Terpapar agen nosokomial', 'Ketidakamanan transportasi'], 'Internal' => ['Ketidaknormalan profil darah', 'Perubahan orientasi afektif', 'Perubahan sensasi', 'Disfungsi autoimun', 'Disfungsi biokimia', 'Hipoksi jaringan', 'Kegagalan mekanisme pertahanan tubuh', 'Malnutrisi', 'Perubahan fungsi psikomotor', 'Perubahan fungsi kognitif']], 'kondisi_klinis_terkait' => ['Tidak tersedia']], 'slki' => [['kode' => 'L.14136', 'nama' => 'Tingkat Cedera', 'kriteria_hasil' => ['Toleransi aktivitas membaik', 'Toleransi makanan membaik', 'Kejadian cedera luka/lecet menurun', 'Fraktur menurun', 'Perdarahan menurun', 'Ekspresi wajah kesakitan menurun', 'Iritabilitas menurun', 'Gangguan mobilitas menurun', 'Gangguan kognitif menurun', 'Tekanan darah membaik', 'Frekuensi nadi membaik', 'Frekuensi napas membaik', 'Pola istirahat/tidur membaik', 'Nafsu makan membaik']]], 'siki' => [['kode' => 'I.14513', 'nama' => 'Manajemen Keselamatan Lingkungan', 'definisi' => 'Mengidentifikasi dan mengelola lingkungan fisik untuk meningkatkan keselamatan', 'tindakan' => ['observasi' => ['Identifikasi kebutuhan keselamatan (mis. Kondisi fisik, fungsi kognitif dan riwayat perilaku)', 'Monitor perubahan status keselamatan lingkungan'], 'terapeutik' => ['Hilangkan bahaya keselamatan lingkungan (mis. Fisik, biologi, dan kimia), jika memungkinkan', 'Modifikasi lingkungan untuk meminimalkan bahaya dan risiko', 'Sediakan alat bantu keamanan lingkungan (mis. Commode chair dan pegangan tangan)', 'Gunakan perangkat pelindung (mis. Pengekangan fisik, rel samping, pintu terkunci, pagar)', 'Hubungi pihak berwenang sesuai masalah komunitas (mis. Puskesmas, polisi, damkar)'], 'edukasi' => ['Ajarkan individu, keluarga dan kelompok risiko tinggi bahaya lingkungan', 'Anjurkan pencegahan cedera melalui implementasi sistem keselamatan pasien'], 'kolaborasi' => []]]]]],
            // D.0137 — Risiko Cedera pada Ibu (updated from PDF p.666-667)
            ['diagkep_id' => 'D.0137', 'diagkep_desc' => 'Risiko Cedera pada Ibu', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami bahaya atau kerusakan fisik pada ibu selama masa kehamilan sampai dengan proses persalinan', 'penyebab' => [], 'faktor_risiko' => ['Besarnya ukuran janin', 'Malposisi janin (posisi posterior)', 'Induksi persalinan', 'Persalinan lama kala I, II dan III', 'Disfungsi uterus', 'Efek metode intervensi bedah selama persalinan', 'Kurangnya dukungan keluarga dan orang tua', 'Kurang adekuatnya observasi dan antisipasi', 'Keterlambatan pengambilan keputusan dan manajemen', 'Skrinning dan perawatan prenatal yang tidak adekuat', 'Kecemasan berlebihan pada proses persalinan', 'Riwayat cedera pada persalinan sebelumnya', 'Usia ibu (<15 tahun atau >35 tahun)', 'Paritas banyak', 'Perubahan hormonal', 'Perubahan postur tubuh', 'Ketuban pecah', 'Proses infeksi', 'Penyakit penyerta', 'Masalah kontraksi'], 'kondisi_klinis_terkait' => ['Penurunan kadar hemoglobin']], 'slki' => [['kode' => 'L.14136', 'nama' => 'Tingkat Cedera', 'kriteria_hasil' => ['Kejadian cedera menurun', 'Perdarahan menurun']]], 'siki' => [['kode' => 'I.07228', 'nama' => 'Perawatan Persalinan Risiko Tinggi', 'definisi' => 'Memberikan asuhan persalinan pada janin multipel atau malposisi', 'tindakan' => ['observasi' => ['Identifikasi kondisi umum pasien', 'Monitor tanda-tanda vital', 'Monitor kelainan tanda vital pada ibu dan janin', 'Monitor tanda-tanda persalinan', 'Monitor denyut jantung janin', 'Identifikasi posisi janin dengan USG', 'Identifikasi perdarahan pascapersalinan'], 'terapeutik' => ['Siapkan peralatan yang sesuai, termasuk monitor janin, ultrasound mesin anestesi, persedian resusitasi neonatal, forceps, dan penghangat bayi ekstra', 'Dukungan orang terdekat mendampingi pasien'], 'edukasi' => ['Jelaskan prosedur tindakan yang akan dilakukan', 'Jelaskan karakteristik bayi baru lahir yang dengan berisiko tinggi (mis. memar dan tanda forceps)'], 'kolaborasi' => ['Koordinasi dengan tim untuk standby (mis. Neonatologis, perawatan intensif, anestesiologis)']]]]]],
            // D.0138 — Risiko Cedera pada Janin (updated from PDF p.668-670)
            ['diagkep_id' => 'D.0138', 'diagkep_desc' => 'Risiko Cedera pada Janin', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami bahaya atau kerusakan fisik pada janin selama proses kehamilan dan persalinan', 'penyebab' => [], 'faktor_risiko' => ['Besarnya ukuran janin', 'Malposisi janin', 'Induksi persalinan', 'Persalinan lama kala I, II, dan III', 'Disfungsi uterus', 'Kecemasan yang berlebihan tentang persalinan', 'Riwayat persalinan sebelumnya', 'Usia ibu (<15 tahun atau >35 tahun)', 'Paritas banyak', 'Efek metode/intervensi bedah selama persalinan', 'Nyeri pada abdomen', 'Nyeri pada jalan lahir', 'Penggunaan alat bantu persalinan', 'Kelelahan', 'Merokok', 'Efek agen farmakologis', 'Pengaruh budaya', 'Pola makan yang tidak sehat', 'Faktor ekonomi', 'Konsumsi alkohol', 'Terpapar agen teratogen'], 'kondisi_klinis_terkait' => ['Ketuban pecah sebelum waktunya', 'Penyakit penyerta: asma, hipertensi, penyakit menular seksual, AIDS', 'Masalah kontraksi', 'Efek pengobatan pada ibu']], 'slki' => [['kode' => 'L.14136', 'nama' => 'Tingkat Cedera', 'kriteria_hasil' => ['Kejadian cedera dari skala cukup meningkat (2) menjadi cukup menurun (4)', 'Luka/lecet dari skala cukup meningkat (2) menjadi cukup menurun (4)', 'Ketegangan otot dari skala sedang (3) menjadi menurun (5)', 'Tekanan darah dari skala cukup memburuk (2) menjadi cukup membaik (4)', 'Frekuensi nadi dari skala cukup memburuk (2) menjadi cukup membaik (4)', 'Nafsu makan dari skala cukup memburuk (2) menjadi cukup membaik (4)']]], 'siki' => [['kode' => 'I.07228', 'nama' => 'Perawatan Persalinan Risiko Tinggi', 'definisi' => 'Memberikan asuhan persalinan pada janin multipel atau malposisi', 'tindakan' => ['observasi' => ['Monitor tanda-tanda vital', 'Identifikasi posisi janin dengan USG', 'Identifikasi perdarahan pasca persalinan'], 'terapeutik' => ['Siapkan peralatan yang sesuai, termasuk monitor janin, ultrasound, mesin anestesi, persediaan resusitasi neonatal, forceps, dan penghangat bayi ekstra', 'Lakukan perineal scrub', 'Lakukan amniotomi selaput ketuban'], 'edukasi' => ['Jelaskan karakteristik bayi baru lahir yang terkait dengan kelahiran berisiko tinggi (mis. memar dan tanda forceps)'], 'kolaborasi' => ['Koordinasi dengan tim untuk standby (mis. neonatologis, perawat intensif, anestesiologis)']]], ['kode' => 'I.14537', 'nama' => 'Pencegahan Cedera', 'definisi' => 'Mengidentifikasi dan menurunkan risiko mengalami bahaya atau kerusakan', 'tindakan' => ['observasi' => ['Identifikasi area lingkungan yang berpotensi menyebabkan cedera'], 'terapeutik' => ['Sediakan pispot atau urinal eliminasi di tempat tidur, jika perlu', 'Diskusikan mengenai dan terapi fisik yang diperlukan'], 'edukasi' => ['Anjurkan berganti posisi secara perlahan dan duduk selama beberapa menit sebelum berdiri'], 'kolaborasi' => []]]]]],
            // D.0139 — Risiko Gangguan Integritas Kulit/Jaringan (updated from PDF p.672-673)
            ['diagkep_id' => 'D.0139', 'diagkep_desc' => 'Risiko Gangguan Integritas Kulit/Jaringan', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami kerusakan kulit (dermis dan/atau epidermis) atau jaringan (membran mukosa, kornea, fasia, otot, tendon, tulang, kartilago, kapsul sendi dan/atau ligamen)', 'penyebab' => [], 'faktor_risiko' => ['Perubahan sirkulasi', 'Perubahan status nutrisi (kelebihan atau kekurangan)', 'Kekurangan/kelebihan volume cairan', 'Penurunan mobilitas', 'Bahan kimia iritatif', 'Suhu lingkungan yang ekstrem', 'Faktor mekanis (mis. Penekanan, gesekan) atau faktor elektris (elektrodiatermi, energi listrik bertegangan tinggi)', 'Terapi radiasi', 'Kelembaban', 'Proses penuaan', 'Neuropati perifer', 'Perubahan pigmentasi', 'Perubahan hormonal', 'Penekanan pada tonjolan tulang', 'Kurang terpapar informasi tentang upaya mempertahankan/melindungi integritas jaringan'], 'kondisi_klinis_terkait' => ['Imobilisasi', 'Gagal jantung kongesif', 'Gagal ginjal', 'Diabetes mellitus', 'Imunodefisiensi (mis. AIDS)', 'Kateterisasi jantung']], 'slki' => [['kode' => 'L.14125', 'nama' => 'Integritas Kulit dan Jaringan', 'kriteria_hasil' => ['Kerusakan jaringan dari skala 1 meningkat menjadi skala 5 menurun', 'Kerusakan kulit dari skala 1 meningkat menjadi skala 5 menurun']]], 'siki' => [['kode' => 'I.11353', 'nama' => 'Perawatan Integritas Kulit', 'definisi' => 'Mengidentifikasi dan merawat kulit untuk menjaga keutuhan, kelembaban dan mencegah perkembangan mikroorganisme', 'tindakan' => ['observasi' => ['Identifikasi penyebab gangguan integritas kulit (mis. Perubahan sirkulasi, perubahan status nutrisi, penurunan kelembaban, suhu lingkungan ekstrem, penurunan mobilitas)'], 'terapeutik' => ['Ubah posisi tiap 2 jam jika tirah baring', 'Lakukan pemijatan pada area penonjolan tulang, jika perlu', 'Bersihkan perineal dengan air hangat, terutama selama periode diare', 'Gunakan produk berbahan petroleum atau minyak pada kulit kering', 'Gunakan produk berbahan ringan/alami dan hipoalergik pada kulit sensitif', 'Hindari produk berbahan dasar alkohol pada kulit kering'], 'edukasi' => ['Anjurkan menggunakan pelembab (mis. Lotion, serum)', 'Anjurkan minum air yang cukup', 'Anjurkan meningkatkan asupan nutrisi', 'Anjurkan meningkatkan asupan buah dan sayur', 'Anjurkan menghindari terpapar suhu ekstrem', 'Anjurkan menggunakan tabir surya SPF minimal 30 saat berada diluar rumah', 'Anjurkan mandi dan menggunakan sabun secukupnya'], 'kolaborasi' => []]]]]],
            // D.0140 — Risiko Hipotermia (updated from PDF p.673-675)
            ['diagkep_id' => 'D.0140', 'diagkep_desc' => 'Risiko Hipotermia', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami kegagalan termogulasi yang dapat mengakibatkan suhu tubuh berada di bawah rentang normal', 'penyebab' => [], 'faktor_risiko' => ['Berat badan ekstrem', 'Kerusakan hipotalamus', 'Konsumsi alkohol', 'Kurangnya lapisan lemak subkutan', 'Suhu lingkungan rendah', 'Malnutrisi', 'Pemakaian pakaian yang tipis', 'Penurunan laju metabolisme', 'Terapi radiasi', 'Tidak beraktivitas', 'Transfer panas (mis. konduksi, konveksi, evaporasi, radiasi)', 'Trauma', 'Prematuritas', 'Penuaan', 'Bayi baru lahir', 'Berat badan lahir rendah', 'Kurang terpapar informasi tentang pencegahan hipotermia', 'Efek agen farmakologis'], 'kondisi_klinis_terkait' => ['Berat badan ekstrim', 'Dehidrasi', 'Kurang mobilitas fisik']], 'slki' => [['kode' => 'L.14134', 'nama' => 'Termoregulasi', 'kriteria_hasil' => ['Menggigil menurun', 'Suhu tubuh membaik']]], 'siki' => [['kode' => 'I.14507', 'nama' => 'Manajemen Hipotermia', 'definisi' => 'Mengidentifikasi dan mengelola suhu tubuh di bawah rentang normal', 'tindakan' => ['observasi' => ['Monitor suhu tubuh', 'Identifikasi penyebab hipotermia (mis. Terpapar suhu lingkungan rendah, pakaian tipis, kerusakan hipotalamus, penurunan laju metabolisme, kekurangan lemak subkutan)', 'Monitor tanda dan gejala akibat hipotermia (hipotermia ringan: asam-basa abnormal, takipnea, disartria, menggigil, hipertensi, diuresis; hipotermia sedang: aritmia, hipotensi, apatis, koagulopati, refleks menurun; hipotermia berat: oliguria, refleks menghilang, edema paru, asam-basa abnormal)'], 'terapeutik' => ['Sediakan lingkungan yang hangat (mis. Atur suhu ruangan, inkubator)', 'Lakukan penghangatan pasif (mis. Selimut, menutup kepala, pakaian tebal)', 'Lakukan penghangatan aktif eksternal (mis. Kompres hangat, botol hangat, selimut hangat, perawatan metode kangguru)', 'Lakukan penghangatan aktif internal (mis. Infus cairan hangat, oksigen hangat, lavase peritoneal cairan hangat)', 'Pemberian terapi sponge dengan menggunakan air hangat'], 'edukasi' => ['Anjurkan makan/minum hangat'], 'kolaborasi' => []]]]]],
            // D.0141 — Risiko Hipotermia Perioperatif (updated from PDF p.675-680)
            ['diagkep_id' => 'D.0141', 'diagkep_desc' => 'Risiko Hipotermia Perioperatif', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami penurunan suhu tubuh di bawah 36°C secara tiba-tiba yang terjadi satu jam sebelum pembedahan hingga 24 jam setelah pembedahan', 'penyebab' => [], 'faktor_risiko' => ['Prosedur pembedahan', 'Kombinasi anastesi region dan umum', 'Skor American Society of Anesthesiologist (ASA) >1', 'Suhu pra-operasi Rendah (<36°C)', 'Berat badan rendah', 'Neuropati diabetik', 'Komplikasi kardiovaskuler', 'Suhu lingkungan rendah', 'Transfer panas (mis. Volume tinggi infus yang tidak dihangatkan, irigasi >2 literasi yang tidak dihangatkan)'], 'kondisi_klinis_terkait' => ['Tindakan Pembedahan']], 'slki' => [['kode' => 'L.14134', 'nama' => 'Termoregulasi', 'kriteria_hasil' => ['Menggigil dari skala 1 meningkat menjadi skala 5 menurun', 'Suhu tubuh dari skala 1 memburuk menjadi skala 5 membaik', 'Suhu kulit dari skala 1 memburuk menjadi skala 5 membaik']]], 'siki' => [['kode' => 'I.14507', 'nama' => 'Manajemen Hipotermia', 'definisi' => 'Mengidentifikasi dan mengelola suhu tubuh di bawah rentang normal', 'tindakan' => ['observasi' => ['Monitor suhu tubuh', 'Identifikasi penyebab hipotermia (mis. terpapar suhu lingkungan rendah, pakaian tipis, kerusakan hipotalamus, penurunan laju metabolisme, kekurangan lemak subkutan)', 'Monitor tanda dan gejala akibat hipotermia (hipotermia ringan: takipnea, disartria, menggigil, hipertensi, diuresis; hipotermia sedang: aritmia, hipotensi, apatis, koagulopati, refleks menurun; hipotermia berat: oliguria, refleks menghilang, edema paru, asam-basa abnormal)'], 'terapeutik' => ['Sediakan lingkungan yang hangat (mis. Atur suhu ruangan, inkubator)', 'Ganti pakaian dan/atau linen yang basah', 'Lakukan penghangatan pasif (mis. Kompres hangat, botol hangat, selimut hangat, perawatan metode kangguru)', 'Lakukan penghangatan aktif internal (mis. Infus cairan hangat, oksigen hangat, lavase peritoneal dengan cairan hangat)'], 'edukasi' => ['Anjurkan makan/minum hangat'], 'kolaborasi' => []]]]]],
            // D.0142 — Risiko Infeksi (updated from PDF p.681-686)
            ['diagkep_id' => 'D.0142', 'diagkep_desc' => 'Risiko Infeksi', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami peningkatan terserang organisme patogenik', 'penyebab' => [], 'faktor_risiko' => ['Penyakit kronis (mis. Diabetes militus)', 'Efek prosedur infasif', 'Malnutrisi', 'Peningkatan paparan organisme patogen lingkungan', 'Ketidak adekuatan pertahanan tubuh primer (Gangguan peristaltik, Kerusakan integritas kulit, Perubahan sekresi pH, Penurunan kerja siliaris, Ketuban pecah lama, Ketuban pecah sebelum waktunya, Merokok, Statis cairan tubuh)', 'Ketidak adekuatan pertahanan tubuh sekunder (Penurunan Hb, Imununosupresi, Leukopenia, Supresi respon inflamasi, Vaksinisasi tidak adekuat)'], 'kondisi_klinis_terkait' => ['AIDS', 'Luka bakar', 'Penyakit paru obstruktif kronik', 'Diabetes mielitus', 'Tindakan infasif', 'Kondisi penggunaan terapi steroid', 'Penyalahgunaan obat', 'Ketuban pecah sebelum waktunya', 'Kanker', 'Leukimia', 'Imunosupresi', 'Lymphedema', 'Leukositopenia', 'Gangguan fungsi hati']], 'slki' => [['kode' => 'L.14137', 'nama' => 'Tingkat Infeksi', 'kriteria_hasil' => ['Kebersihan badan meningkat']]], 'siki' => [['kode' => 'I.14539', 'nama' => 'Pencegahan Infeksi', 'definisi' => 'Mengidentifikasi dan menurunkan risiko terserang organisme patogenik', 'tindakan' => ['observasi' => ['Monitor tanda dan gejala infeksi lokal dan sistemik'], 'terapeutik' => ['Cuci tangan sebelum dan sesudah kontak dengan pasien dan lingkungan pasien', 'Pertahankan teknik aseptik pada pasien berisiko tinggi'], 'edukasi' => ['Jelaskan tanda dan gejala infeksi', 'Ajarkan cara mencuci tangan dengan benar'], 'kolaborasi' => ['Kolaborasi pemberian imunisasi, jika perlu']]]]]],
            // D.0143 — Risiko Jatuh (updated from PDF p.687-689)
            ['diagkep_id' => 'D.0143', 'diagkep_desc' => 'Risiko Jatuh', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami kerusakan fisik dan gangguan kesehatan akibat terjatuh', 'penyebab' => [], 'faktor_risiko' => ['Usia >65 tahun (pada dewasa) atau <2 tahun (pada anak)', 'Riwayat jatuh', 'Anggota gerak bawah prostetis (buatan)', 'Penggunaan alat bantu berjalan', 'Penurunan tingkat kesadaran', 'Perubahan fungsi kognitif', 'Lingkungan tidak aman (mis. licin, gelap, lingkungan asing)', 'Kondisi pasca operasi', 'Hipotensi ortostatik', 'Perubahan kadar glukosa darah', 'Anemia', 'Kekuatan otot menurun', 'Gangguan Pendengaran', 'Gangguan keseimbangan', 'Gangguan penglihatan (mis. glaukoma, katarak, ablasio retina, neuritis optikus)', 'Neuropati', 'Efek agen farmakologis (mis. sedasi, alkohol, anastesi umum)'], 'kondisi_klinis_terkait' => ['Osteoporosis', 'Kejang', 'Penyakit sebrovaskuler', 'Katarak', 'Glaukoma', 'Demensia', 'Hipotensi', 'Amputasi', 'Intoksikasi', 'Preeklampsi']], 'slki' => [['kode' => 'L.14138', 'nama' => 'Tingkat Jatuh', 'kriteria_hasil' => ['Jatuh dari tempat tidur dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Jatuh saat berdiri dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Jatuh saat duduk dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Jatuh saat berjalan dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Jatuh saat dipindahkan dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Jatuh saat naik tangga dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Jatuh saat di kamar mandi dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)', 'Jatuh saat membungkuk dari skala 1 (meningkat) menjadi skala 4 (cukup menurun)']]], 'siki' => [['kode' => 'I.14540', 'nama' => 'Pencegahan Jatuh', 'definisi' => 'Mengidentifikasi dan menurunkan risiko terjatuh akibat perubahan kondisi fisik atau psikologis', 'tindakan' => ['observasi' => ['Identifikasi Faktor risiko jatuh (mis. usia >65 tahun, penurunan tingkat kesadaran, defisit kognitif, hipotensi ortostatik, gangguan keseimbangan, gangguan penglihatan, neuropati)', 'Identifikasi faktor lingkungan yang meningkatkan risiko jatuh (mis. lantai licin, penerangan kurang)', 'Monitor kemampuan berpindah dari tempat tidur ke kursi roda dan sebaliknya'], 'terapeutik' => ['Orientasikan Ruangan pada pasien dan keluarga', 'Pastikan roda tempat tidur dan kursi roda selalu dalam kondisi terkunci', 'Pasang handrail tempat tidur', 'Tempatkan pasien berisiko tinggi jatuh dekat dengan pantauan perawat dari nurse station', 'Gunakan alat bantu berjalan (mis. kursi roda, walker)'], 'edukasi' => ['Anjurkan memanggil perawat jika membutuhkan bantuan untuk berpindah', 'Anjurkan menggunakan alas kaki yang tidak licin', 'Ajarkan cara menggunakan bel pemanggil untuk memanggil perawat'], 'kolaborasi' => []]]]]],
            // D.0144 — Risiko Luka Tekan (updated from PDF p.689-690)
            ['diagkep_id' => 'D.0144', 'diagkep_desc' => 'Risiko Luka Tekan', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami cedera lokal pada kulit dan/atau jaringan, biasanya pada tonjolan tulang akibat tekanan dan/atau gesekan', 'penyebab' => [], 'faktor_risiko' => ['Skor skala Braden Q ≤16 (anak) atau skor skala Braden ≤18 (dewasa)', 'Perubahan fungsi kognitif', 'Perubahan sensasi', 'Skor ASA (American in Sensation Anethesiologist) ≥2', 'Anemia', 'Penurunan mobilisasi', 'Penurunan kadar albumin', 'Penurunan oksigenesi jaringan', 'Penurunan perfusi jaringan', 'Dehidrasi', 'Kulit kering', 'Edema', 'Peningkatan suhu kulit 1-2°C', 'Periode imobilisasi yang keras (mis. prosedur operasi ≥2 jam)', 'Usia ≥65 tahun', 'Berat badan lebih', 'Fraktur tungkai', 'Riwayat stroke', 'Riwayat luka tekan', 'Riwayat trauma', 'Hipertermi', 'Inkontinensia', 'Ketidakadekuatan nutrisi', 'Skor RAPS (Risk Assesment Pressure Score) Rendah', 'Klasifikasi fungsional NYHA (New York Heart Association) ≥2', 'Efek agen farmakologis (mis. Anatesi umum, vasopressor, antidepresan, norepinefrin)', 'Imobilisasi fisik', 'Penekanan di atas tonjolan tulang', 'Penurunan tebal lipatan kulit trisep', 'Kulit bersisik', 'Gesekan permukaan kulit'], 'kondisi_klinis_terkait' => ['Anemia', 'Gagal jantung kongestif', 'Trauma', 'Stroke', 'Malnutrisi', 'Obesitas', 'Fraktur tungkai', 'Cedera medula spinalis dan/atau kepala', 'Imobilisasi']], 'slki' => [['kode' => 'L.14125', 'nama' => 'Integritas Kulit dan Jaringan', 'kriteria_hasil' => ['Elastisitas kulit dari skala 1 meningkat menjadi skala 5 menurun', 'Kerusakan jaringan dari skala 1 meningkat menjadi skala 5 menurun', 'Kerusakan kulit dari skala 1 meningkat menjadi skala 5 menurun', 'Frekuensi nyeri dari skala 1 meningkat menjadi skala 5 menurun', 'Pengukuran suhu kulit dari skala 1 meningkat menjadi skala 5 menurun']]], 'siki' => [['kode' => 'I.06195', 'nama' => 'Manajemen Sensasi Perifer', 'definisi' => 'Mengidentifikasi dan mengelola ketidaknyamanan pada perubahan sensasi perifer', 'tindakan' => ['observasi' => ['Identifikasi penyebab perubahan sensasi', 'Identifikasi penggunaan alat pengikat, prostesis, sepatu dan pakaian', 'Periksa perbedaan sensasi tajam atau tumpul', 'Periksa perbedaan sensasi panas atau dingin', 'Periksa kemampuan mengidentifikasi lokasi dan tekstur benda', 'Monitor terjadinya parestesia, jika perlu', 'Monitor perubahan kulit', 'Monitor adanya tromboflebitis dan tromboemboli vena'], 'terapeutik' => ['Hindari pemakaian benda-benda yang suhunya terlalu panas atau dingin'], 'edukasi' => ['Anjurkan penggunaan termometer untuk menguji suhu air', 'Anjurkan penggunaan sarung tangan termal saat memasak', 'Anjurkan memakai sepatu lembut dan bertumit rendah'], 'kolaborasi' => ['Kolaborasi pemberian analgesik, jika perlu', 'Kolaborasi pemberian kortikosteroid, jika perlu']]]]]],
            // D.0145 — Risiko Mutilasi Diri (updated from PDF p.691-692)
            ['diagkep_id' => 'D.0145', 'diagkep_desc' => 'Risiko Mutilasi Diri', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko sengaja mencederai diri yang menyebabkan kerusakan fisik untuk memperoleh pemulihan ketegangan', 'penyebab' => [], 'faktor_risiko' => ['Perkembangan remaja', 'Individu autistik', 'Gangguan kepribadian', 'Penyakit keturunan', 'Penganiayaan (mis. Fisik, psikologis, seksual)', 'Gangguan hubungan interpersonal', 'Perceraian keluarga', 'Keterlambatan perkembangan', 'Riwayat perilaku mencederai diri', 'Ancaman kehilangan hubungan yang bermakna', 'Ketidakmampuan mengungkapkan ketegangan secara verbal', 'Ketidakmampuan mengatasi masalah', 'Harga diri rendah', 'Peningkatan ketegangan yang tidak dapat ditoleransi'], 'kondisi_klinis_terkait' => ['Gangguan Kepribadian', 'Gangguan Mental Organik', 'Autisme', 'Skizofernia', 'Depresi Mayor', 'Dissociative Identity Disorder', 'Masokisme Seksual', 'Gangguan afektis atau mania', 'Riwayat penganiayaan']], 'slki' => [['kode' => 'L.09076', 'nama' => 'Kontrol Diri', 'kriteria_hasil' => ['Perilaku melukai diri sendiri menurun']]], 'siki' => [['kode' => 'I.09287', 'nama' => 'Pencegahan Perilaku Kekerasan', 'definisi' => 'Meminimalkan kemarahan yang diekspresikan secara berlebihan dan tidak terkendali', 'tindakan' => ['observasi' => ['Monitor adanya benda yang berpotensi membahayakan (mis. benda tajam, tali)', 'Monitor keamanan barang yang dibawa oleh pengunjung', 'Monitor selama penggunaan barang yang dapat membahayakan (mis. pisau cukur)'], 'terapeutik' => ['Pertahankan lingkungan bebas dari bahaya secara rutin', 'Libatkan keluarga dalam perawatan'], 'edukasi' => ['Anjurkan pengunjung dan keluarga untuk mendukung keselamatan pasien', 'Latih cara mengungkapkan perasaan secara asertif', 'Latih mengurangi kemarahan secara verbal dan nonverbal (mis. relaksasi, bercerita)'], 'kolaborasi' => []]]]]],
            // D.0146 — Risiko Perilaku Kekerasan (updated from PDF p.692-694)
            ['diagkep_id' => 'D.0146', 'diagkep_desc' => 'Risiko Perilaku Kekerasan', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko membahayakan secara fisik, emosi dan/atau seksual pada diri sendiri atau orang lain', 'penyebab' => [], 'faktor_risiko' => ['Pemikiran waham/delusi', 'Curiga pada orang lain', 'Halusinasi', 'Berencana bunuh diri', 'Disfungsi sistem keluarga', 'Kerusakan kognitif', 'Disorientasi atau konfusi', 'Kerusakan kontrol impuls', 'Persepsi pada lingkungan tidak akurat', 'Alam perasaan depresi', 'Riwayat kekerasan pada hewan', 'Kelainan neurologis', 'Lingkungan tidak teratur', 'Penganiayaan atau pengabaian anak', 'Riwayat atau ancaman kekerasan terhadap diri sendiri atau orang lain atau destruksi properti orang lain', 'Impulsi', 'Ilusi'], 'kondisi_klinis_terkait' => ['Penganiayaan fisik, psikologis atau seksual', 'Sindrom otak organik (mis. penyakit Alzheimer)', 'Gangguan perilaku', 'Oppositional defiant disorder', 'Depresi', 'Serangan panik', 'Gangguan Tourette', 'Delirium', 'Demensia', 'Gangguan amnestik', 'Halusinasi', 'Upaya bunuh diri', 'Abnormalitas neurotransmitter otak']], 'slki' => [['kode' => 'L.09076', 'nama' => 'Kontrol Diri', 'kriteria_hasil' => ['Validasi ancaman kepada orang lain dari skala 1 meningkat menjadi skala 5 menurun', 'Verbalisasi umpatan dari skala 1 meningkat menjadi skala 5 menurun', 'Perilaku menyerang dari skala 1 meningkat menjadi skala 5 menurun', 'Perilaku melukai diri sendiri/orang lain dari skala 1 meningkat menjadi skala 5 menurun', 'Perilaku merusak lingkungan sekitar dari skala 1 meningkat menjadi skala 5 menurun', 'Perilaku agresif/amuk dari skala 1 meningkat menjadi skala 5 menurun', 'Suara keras dari skala 1 meningkat menjadi skala 5 menurun', 'Bicara ketus dari skala 1 meningkat menjadi skala 5 menurun']]], 'siki' => [['kode' => 'I.14544', 'nama' => 'Pencegahan Perilaku Kekerasan', 'definisi' => 'Meminimalkan kemarahan yang diekspresikan secara berlebihan dan tidak terkendali secara verbal sampai dengan mencederai orang lain dan/atau merusak lingkungan', 'tindakan' => ['observasi' => ['Monitor adanya benda yang berpotensi membahayakan (mis. benda tajam, tali)', 'Monitor keamanan barang yang dibawa oleh pengunjung', 'Monitor selama penggunaan barang yang dapat membahayakan (mis. pisau cukur)'], 'terapeutik' => ['Pertahankan lingkungan bebas dari bahaya secara rutin', 'Libatkan keluarga dalam perawatan'], 'edukasi' => ['Anjurkan pengunjung dan keluarga untuk mendukung keselamatan pasien', 'Latih cara mengungkapkan perasaan secara asertif', 'Latih mengurangi kemarahan secara verbal dan nonverbal (mis. relaksasi, bercerita)'], 'kolaborasi' => []]]]]],
            // D.0147 — Risiko Perlambatan Pemulihan Pascabedah (updated from PDF p.694-695)
            ['diagkep_id' => 'D.0147', 'diagkep_desc' => 'Risiko Perlambatan Pemulihan Pascabedah', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami pemanjangan jumlah hari Pascabedah untuk memulai dan melakukan aktivitas sehari-hari', 'penyebab' => [], 'faktor_risiko' => ['Skor klasifikasi status fisik American Society of Anesthesiologist (ASA) (doe sambungan itu tandag lebih dari sama dengan 3)', 'Hiperglikemia', 'Edema di lokasi pembedahan', 'Prosedur pembedahan ekstensif (luas)', 'Usia ekstrem', 'Riwayat perlambatan penyembuhan luka', 'Gangguan mobilitas', 'Malnutrisi', 'Obesitas', 'Infeksi luka perioperatif', 'Mual/muntah persisten', 'Respon emosional pasca operasi', 'Pemanjangan proses operasi', 'Gangguan psikologis pasca operasi', 'Kontaminasi bedah', 'Trauma luka operasi', 'Efek agen farmakologis'], 'kondisi_klinis_terkait' => ['Tindakan operasi besar', 'Trauma yang memerlukan intervensi bedah']], 'slki' => [['kode' => 'L.14129', 'nama' => 'Pemulihan Pascabedah', 'kriteria_hasil' => ['Kenyamanan dari skala 1 menurun menjadi skala 5 meningkat', 'Waktu penyembuhan dari skala 1 meningkat menjadi skala 5 menurun', 'Kemampuan perawatan diri dari skala 1 menurun menjadi skala 5 meningkat', 'Area luka operasi dari skala 1 memburuk menjadi skala 5 membaik']]], 'siki' => [['kode' => 'I.05173', 'nama' => 'Dukungan Mobilisasi', 'definisi' => 'Memfasilitasi pasien untuk meningkatkan aktivitas pergerakan fisik', 'tindakan' => ['observasi' => ['Identifikasi adanya nyeri atau keluhan fisik lainnya', 'Identifikasi toleransi fisik melakukan pergerakan', 'Monitor frekuensi jantung dan tekanan darah sebelum memulai mobilisasi', 'Monitor kondisi umum selama melakukan mobilisasi'], 'terapeutik' => ['Fasilitasi aktivitas mobilisasi dengan alat bantu (Mis. Pagar tempat tidur)', 'Fasilitasi melakukan pergerakan, jika perlu', 'Libatkan keluarga untuk membantu pasien dalam meningkatkan pergerakan'], 'edukasi' => ['Jelaskan tujuan dan prosedur mobilisasi', 'Anjurkan melakukan mobilisasi dini', 'Ajarkan mobilisasi sederhana yang harus dilakukan (mis. Duduk di tempat tidur, duduk di sisi tempat tidur, pindah dari tempat tidur ke kursi)'], 'kolaborasi' => []]]]]],
            // D.0148 — Risiko Termoregulasi Tidak Efektif (updated from PDF p.696-698)
            ['diagkep_id' => 'D.0148', 'diagkep_desc' => 'Risiko Termoregulasi Tidak Efektif', 'diagkep_json' => ['sdki' => ['kategori' => 'Lingkungan', 'subkategori' => 'Keamanan dan Proteksi', 'definisi' => 'Berisiko mengalami kegagalan mempertahankan suhu tubuh dalam rentang normal', 'penyebab' => [], 'faktor_risiko' => ['Cedera otak akut', 'Dehidrasi', 'Pakaian yang tidak sesuai untuk suhu lingkungan', 'Peningkatan area permukaan tubuh terhadap rasio berat badan', 'Kebutuhan oksigen meningkat', 'Perubahan laju metabolisme', 'Proses penyakit (mis. Infeksi)', 'Suhu lingkungan ektrem', 'Suplai lemak subkutan tidak memadai', 'Berat badan ekstrem', 'Efek agen farmakologis (mis. Sedasi)'], 'kondisi_klinis_terkait' => ['Cedera otak akut', 'Dehidrasi', 'Trauma']], 'slki' => [['kode' => 'L.14134', 'nama' => 'Termoregulasi', 'kriteria_hasil' => ['Menggigil membaik', 'Kulit merah membaik', 'Kejang membaik', 'Akrosianosis membaik', 'Konsumsi oksigen membaik', 'Piloereksi membaik', 'Vasokontriksi perifer membaik', 'Kutis memorata membaik', 'Pucat membaik', 'Takikardi membaik', 'Takipnea membaik', 'Bradikardi membaik', 'Dasar kuku sianotik membaik', 'Hipoksia membaik', 'Suhu tubuh membaik', 'Suhu kulit membaik', 'Kadar glukosa darah membaik', 'Pengisian kapiler membaik', 'Ventilasi membaik', 'Tekanan darah membaik']]], 'siki' => [['kode' => 'I.12414', 'nama' => 'Edukasi Pengukuran Suhu Tubuh', 'definisi' => 'Mengajarkan cara pengukuran suhu tubuh', 'tindakan' => ['observasi' => ['Identifikasi kesiapan dan kemampuan menerima informasi'], 'terapeutik' => ['Sediakan materi dan media Pendidikan Kesehatan', 'Jadwalkan Pendidikan Kesehatan sesuai kesepakatan', 'Berikan kesempatan untuk bertanya', 'Dokumentasikan hasil pengukuran suhu'], 'edukasi' => ['Jelaskan prosedur pengukuran suhu tubuh', 'Anjurkan terus memegang bahu dan menahan dada saat pengukuran aksila', 'Ajarkan memilih lokasi pengukuran suhu oral dan aksila', 'Ajarkan cara meletakkan ujung termometer di bawah lidah atau di bagian tengah aksila', 'Ajarkan cara membaca hasil termometer raksa dan/atau elektronik'], 'kolaborasi' => []]], ['kode' => 'I.12457', 'nama' => 'Edukasi Termoregulasi', 'definisi' => 'Mengajarkan pasien untuk mendukung keseimbangan antara produksi panas, mendapatkan panas, dan kehilangan panas', 'tindakan' => ['observasi' => ['Identifikasi kesiapan dan kemampuan menerima informasi'], 'terapeutik' => ['Sediakan materi dan media Pendidikan Kesehatan', 'Jadwalkan Pendidikan Kesehatan sesuai kesepakatan', 'Berikan kesempatan untuk bertanya'], 'edukasi' => ['Ajarkan kompres hangat jika demam', 'Ajarkan cara pengukuran suhu', 'Anjurkan tetap memandikan pasien, jika memungkinkan', 'Anjurkan pemberian antipiretik, sesuai indikasi', 'Anjurkan menciptakan lingkungan yang nyaman', 'Anjurkan membanyak minum', 'Anjurkan penggunaan pakaian yang longgar', 'Anjurkan minum analgesic jika merasa pusing, sesuai indikasi', 'Anjurkan pemeriksaan darah jika demam >3 hari'], 'kolaborasi' => []]]]]],
