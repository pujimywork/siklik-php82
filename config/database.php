    ...
    */
    ...
    'connections' => [
        ...
        'oracle_siklik' => [
            'driver' => 'oracle',
            'tns' => '',
            'host' => env('SIKLIK_DB_HOST', ''),
            'port' => env('SIKLIK_DB_PORT', '1521'),
            'database' => env('SIKLIK_DB_DATABASE', ''),
            'service_name' => env('SIKLIK_DB_SERVICE_NAME', 'orcl'),
            'username' => env('SIKLIK_DB_USERNAME', ''),
            'password' => env('SIKLIK_DB_PASSWORD', ''),
            'charset' => 'AL32UTF8',
            'prefix' => '',
            'prefix_schema' => '',
            'server_version' => '11g',
